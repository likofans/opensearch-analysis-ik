...
* optional 1 - download pre-build package from here: https://github.com/medcl/opensearch-analysis-ik/releases

    create plugin folder `cd your-es-root/plugins/ && mkdir ik`
    
    unzip plugin to folder `your-es-root/plugins/ik`

* optional 2 - use opensearch-plugin to install ( supported from version v5.5.1 ):

    ```
    ./bin/opensearch-plugin install https://github.com/medcl/opensearch-analysis-ik/releases/download/v6.3.0/opensearch-analysis-ik-6.3.0.zip
    ```

   NOTE: replace `6.3.0` to your own opensearch version
